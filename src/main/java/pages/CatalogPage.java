...
public class CatalogPage extends ParentPage {
    ...
    @FindBy(xpath = ".//ul[@class='ctlg-left__list']/li[@class='ctlg-left__item']/a[@data-section=\"392\"]")
    private WebElement fictionSection;
    ...
    public void clickOnFictionSection(){this.actionWithElements.clickOnElement(this.fictionSection);}
